...
+ [Start] -> check_level
+ [(wait for: current_level)] -> debug_level_changed
...
=== level_8 ===
{ stopping:
  - Level 8! You made it! Okay, so give it a shot ;)
  - Something's wrong with this level, how can you pass it?
}
<- debug_and_hack(-> check_level)
+ [Give me a hint]
...
+ (hint) [Give me a hint]
  { cycle:
    - Try making the radius really small.
    - Play around with the gravity and see what happens!
}
