...
* [(wait for: code not contains "Welcome")] (Done)
-> htmlintro1_5
...
Look for the <tt>&lt;body&gt;</tt>tag in the code, near the top of the page. Just like we did for the <t>&lt;p&gt;</tt> and <tt>&lt;h1&gt;</tt> tags, we're going to insert some new information in there.
This time, though, we need a slightly different wording - <tt>style="background-color:coral"<tt>
+ [Hints] -> htmlintro2_8hints
* [(wait for: code contains "<body style=\"background-color:coral\">")](Done)
-> htmlintro2_9
