...
{open_web_page("https:\/\/editor.p5js.org\/madetohack\/sketches\/nrUIQZX5")}
* [❯] Wait for open webpage
-> p5jsintro3_2

=== p5jsintro3_2 ===
-Now it's time to take a closer look at the two main parts of this program: <tt>setup()</tt> and <tt>draw()</tt>
...
=== p5jsintro3_4 ===
- If your cursor is <b>outside</b> the canvas, what kind of numbers might the program see for mouseX and mouseY? Remember, those numbers are how the program tracks where the cursor is.
* [❯] It depends on where the cursor is outside the canvas!
-> p5jsintro3_3_clever

=== p5jsintro3_3_clever ===
- It depends! The program can't go lower than 0 or higher than 600, so it just takes the numbers that represent where it last "saw" the cursor in the canvas.
