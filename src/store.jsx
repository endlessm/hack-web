      ...
      cards: [
        {
          ...
          name: 'Side-by-Side',
          subtitle: 'Try Endless OS out!',
          description: 'There are multiple ways to run Endless OS without switching away from MacOS or Windows: You can install Endless OS alongside, and choose what OS to use whenever you start your computer, or you can run it as a virtual machine - a computer inside your computer.',
        },
        {
          slug: '/os/os-02',
          href: 'https://endlessos.com/download/',
